...
public class Lambda_04_Test {
    ...
    public void test_filter_map_forEach() throws Exception {
        ...
        personFuncCollection
                ...
                .forEach(t -> {
                	assert t.getBalance().equals(1000);
    ...
    public void test_filter_map_forEach_with_vars() throws Exception {
        ...
        GenericPredicate filterByAge = t -> ((Person) t).getAge() > 50;
        ...
        Processor verifyAccount = t -> {
        	assert ((Account) t).getBalance().equals(1000);
        	assert ((Account) t).getOwner().getAge() > 50;
        };
